...
import { ref } from "vue";
import WebRecorder from "./app/webrecorder.js";
import { SpeechRecognizer } from "./app/speechrecognizer.js";
...
export function start(fn, fn2) {
  ...
  speechRecognizer.OnRecognitionResultChange = (res) => {
    console.log("应该调用fn", fn(`${res.result.voice_text_str}`));
    console.log("识别变化时", res);
  };
  // 一句话结束
  speechRecognizer.OnSentenceEnd = (res) => {
    console.log("一句话结束", res);
    fn2(res.result.voice_text_str);
  };
  // 识别结束
